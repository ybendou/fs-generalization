...
VALIDATION_FEATURES="no_ME"$DATASET$"_validation";#"no_MEminiimagenet_validation";no_MEmetadataset_imagenet_test_features
TEST_DATASET=$DATASET"_test_with_full_cov_mds"$MDS;#"miniimagenet_test";metadataset_vgg_flower_test
TEST_FEATURES="no_ME"$DATASET"_test";#"no_MEminiimagenet_test";no_MEmetadataset_vgg_flower_test_features
DEVICE="cpu"
N_RUNS=1000;
N_WAYS=2;
MAXK=50;
